...
mod process_mint_community_token;
...
use process_mint_community_token::*;
...
pub fn process_instruction(
    ...
    match instruction {
        ...
        GovernanceInstruction::MintCommunityToken {} => {
            process_mint_community_token(program_id, accounts)
        }
    }
}
